    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=13, validators=[django.core.validators.RegexValidator(message='Phone number must start with +98 and be 13 digits long, or start with 0 and be 11 digits long', regex='^(\\+98|0)\\d{10}$')])),
